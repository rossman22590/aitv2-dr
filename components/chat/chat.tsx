...
const pulsingStyles = `
  ...
  .in-progress-text {
    ...
    animation: textGradient 1.5s ease infinite;
  }
`;

const InProgressMessage = ({ content }: { content: string }) => {
  ...
  return (
    <div className="flex items-start space-x-4 overflow-hidden">
      <div className="flex-shrink-0 w-8 h-8 bg-primary rounded-full" />
      <div className="flex-grow overflow-hidden">
        <p className="text-sm font-medium text-muted-foreground mb-1">AI</p>
        <div className="prose break-words overflow-hidden">
          <p className="in-progress-text">{currentLine}</p>
        </div>
      </div>
    </div>
  );
...
export function Chat({
  ...
  const [stage, setStage] = useState<"initial" | "feedback" | "researching">("initial");
  ...
  const sendResearchQuery = async (
    ...
    try {
      setIsLoading(true);
      setProgress([]);
      setInProgressMessage("Starting in-depth research based on your inputs...");
            ...
            try {
              ...
              if (event.type === "progress") {
                if (event.step.type !== "report") {
                  ...
                  setInProgressMessage(event.step.content);
                }
                ...
                setInProgressMessage(event.content);
              }
            } catch (e) {
        ...
        >
          ...
          >
                ...
                >
                  ...
                  >
                    ...
                    <img
                      src="/icon.png"
                      alt="Brain Circuit"
                      className="w-16 h-16 object-contain drop-shadow-[0_0_15px_rgba(var(--primary),0.3)]"
                    />
                  </motion.div>
            ...
            <div className="p-4 md:p-6 space-y-6">
              ...
              {inProgressMessage && (
                <InProgressMessage content={inProgressMessage} />
              )}
